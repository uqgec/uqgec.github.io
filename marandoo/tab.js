...
//get_data_and_plot(data_weather,public_key_daisy_weather,grf_weather_daisy,{treatment_func:data_treatment_weather_daisy,plot_location:'#London',data_size:{'gte' :{'timestamp' : 'now - 14 days'}}})
get_data_and_plot(data_sensor_daisy,public_key_daisy,grf_sensor,{treatment_func:data_treatment_sensor_daisy,plot_location:'#London',data_size:{'gte' :{'timestamp' : 'now - 14 days'}}})
...
//get_data_and_plot(data_weather,public_key_daisy_weather,grf_weather_daisy,{treatment_func:data_treatment_weather_daisy,plot_location:'#Paris',data_size:{'gte' :{'timestamp' : 'now - 30 days'}}})
...
//get_data_and_plot(data_weather,public_key_daisy_weather,grf_weather_daisy,{treatment_func:data_treatment_weather_daisy,plot_location:'#Tokyo',data_size:{sample:2}})
get_data_and_plot(data_sensor_daisy,public_key_daisy,grf_sensor,{treatment_func:data_treatment_sensor_daisy,plot_location:'#Tokyo',data_size:{sample:2}})
});
