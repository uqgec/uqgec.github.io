...
var text = svg_pic.selectAll("text")
     ...
     .enter()
     .append("text")
     .text("Schematic View of the Column Setup")
...
var imgs = svg_pic.selectAll("image").data([0]);
     imgs.enter()
     .append("svg:image")
     .attr("xlink:href", "https://outbox.eait.uq.edu.au/uqczhan2/Grange/Grange_setup.jpg")
     .attr("x", "00")
     .attr("y", "30")
     .attr("width", "1280")
     .attr("height", "1024");
...
var text = svg_pic_realtime.selectAll("text")
     ...
     .enter()
     .append("text")
     .text("Actual View Of The Column Setup")
     .style("font-size", "25px")
     .attr("x", "0")
     .attr("y", "20");
...
var imgs = svg_pic_realtime.selectAll("image").data([0]);
     imgs.enter()
     .append("svg:image")
     .attr("xlink:href", "https://outbox.eait.uq.edu.au/uqxlei/grange/grange.jpg")
//     .attr("xlink:href", "https://outbox.eait.uq.edu.au/uqczhan2/Grange/Grange_setup.PNG")
     .attr("x", "00")
     .attr("y", "50")
     .attr("width", "1280")
     .attr("height", "924");
