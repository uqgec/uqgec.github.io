...
get_data_and_plot(data_weather,public_key_weather,grf_weather,{treatment_func:data_treatment_weather,plot_location:'#London',data_size:{page:1}})
get_data_and_plot(data_sensor_daisy,public_key,grf_2,{treatment_func:data_treatment_sensor_daisy,plot_location:'#London',data_size:{page:1}})
