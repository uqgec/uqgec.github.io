...
get_data_and_plot(data_compacted_redmud,public_key_area51,grf_compacted_redmud,{treatment_func:data_treatment_compacted_redmud ,plot_location:'#London',data_size:{'gte' :{'timestamp' : 'now - 7 days'}}});
...
get_data_and_plot(data_compacted_redmud,public_key_area51,grf_compacted_redmud,{treatment_func:data_treatment_compacted_redmud,plot_location:'#Paris',data_size:{'gte' :{'timestamp' : 'now - 30 days'}}});
});


$( ".tablinks" ).eq(2).one( "click", function() {
get_data_and_plot(data_compacted_redmud,public_key_aster,grf_compacted_redmud,{treatment_func:data_treatment_compacted_redmud,plot_location:'#Tokyo',data_size:{sample:2}});
});
